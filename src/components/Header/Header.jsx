  ...
  return (
    <header className="flex items-center justify-between bg-white shadow-sm p-4 md:p-6 w-full">
      ...
      <nav className="flex items-center space-x-6">
        ...
        {!isLoggedIn && (
          <>
            <Link to="/login" className="text-sm text-gray-700 font-bold border custom-primary-border rounded-md px-4 py-2 hover:bg-gray-50">Log In</Link>
            <Link to="/signup" className="text-sm text-white font-bold custom-primary-bg rounded-md px-4 py-2 custom-primary-bg-hover">Sign Up</Link>
          </>
        )}
